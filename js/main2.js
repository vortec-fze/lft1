...
$(document).ready(function () {
    ...
    $('#savebttn').bind('click', function() {
       ...
       // });
        ...
        //alert (shoulder);
       // for (i = 1; i<3; i++) {
            //alert("Number of " + arr2[i] + " on " + d +" is " + arr[i] + ".");
        //  alert(workday[i]);
        //  quads++;  
    //    }
      //  if($("#dailytally").val() == '') 
    ...
    //    }
        ...
        $('#dataDisplay').prepend("<li>" + d + ": " + dailytally.shoulders + ", " + dailytally.biceps + ", " + dailytally.triceps + ", " + dailytally.forearms + ", " + dailytally.chest + ", " + dailytally.upperback + ", " + dailytally.midback + ", " + dailytally.lowerback + ", " + dailytally.stomach + ", " + dailytally.butt + ", " + dailytally.quads + ", " + dailytally.hamstrings + ", " + dailytally.calves + "</li>");
